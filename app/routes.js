...
module.exports = function (app, passport, db) {
  ...
  app.put("/thumbUp", (req, res) => {
    const _id = ObjectId(req.body._id); // this is extracting the Id that is being sent fromt he front end to the back end: it is being wrapped so that MongoDB can locate the object
